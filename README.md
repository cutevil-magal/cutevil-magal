...
<h3 align="center">Frontend-разработчик из Минска, открыта для предложений</h3>
...
- 📄 Ознакомиться с моим опытом: [Резюме](https://career.habr.com/...) *<!-- Ссылку на резюме на HH или Habr Career -->*
...
*   **Telegram:** [@your_telegram](https://t.me/your_telegram) *<!-- Укажите свой Telegram -->*
*   **LinkedIn:** [Ваш LinkedIn](https://linkedin.com/in/your-profile) *<!-- Создайте и укажите ссылку -->*

---
<!---
cutevil-magal/cutevil-magal — это специальный репозиторий, чьё `README.md` отображается в профиле GitHub.
--->
